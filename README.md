...
`● Use Git to maintain, upload and share code with other developers`

`● Understand and implement responsive design and user experience best
practices.`

`● Use industry standard Integrated Development Environments such as Sublime
Text`

`● Teamwork and collaboration through inclass`
...
`● Use industry standard Integrated Development Environments such as PyCharm`
...
`● Be able to access and manipulate data effectively including Structured and
Unstructured data using MongoDB and MySQL databases.`

`● Use the Flask micro framework`

`● Use the skills gained in Module 1 to create data visualisations`

`● Teamwork and collaboration through inclas`s
