...
var myData = [3, 5, 8, 9, 10, 12, 15, 20, 21, 30, 32, 45, 50, 58, 60, 64, 70, 75, 83, 87, 90, 99, 103, 115]; // create an array
myData.sort(d3.ascending); // sort the data (ascending by default)
