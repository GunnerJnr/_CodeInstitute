...
class Product(models.Model):
    ...
    def paypal_form(self):  
        ...
        Invoice: A string to uniquely identify our transaction. In our case, we’re combining the primary key value of our product and a randomly generated unique id
